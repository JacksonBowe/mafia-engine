...
def resolve():
    players = [{'id': 'user-2', 'name': 'UserName2', 'alias': 'UserAlias2', 'role': 'Mafioso', 'number': 1, 'alive': True, 'possibleTargets': [], 
            'targets': [3], 'allies': [], 'roleActions': {}}, {'id': 'user-3', 'name': 'UserName3', 'alias': 'UserAlias3', 'role': 'Mafioso', 'number': 2, 'alive': True, 'possibleTargets': [], 'targets': [], 'allies': [], 'roleActions': {}}, {'id': 'user-1', 'name': 'UserName1', 'alias': 'UserAlias1', 'role': 'Citizen', 'number': 3, 'alive': True, 'possibleTargets': [], 'targets': [], 'allies': [], 'roleActions': {'remainingVests': 2}}]
