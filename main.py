...
def load_lynch():
    ...
    state = {
        "day": 1,
        "players": [
            {"number": 2, "alias": "Gordon", "alive": True},
        ],
        "graveyard": [
            {
                "number": 1,
    ...
    config = {
        ...
        "settings": {},
        "roles": {"Citizen": {"max": 1, "weight": 1, "settings": {"maxVests": 2}}},
    }
...
def create_unbalanced():
    players = [
        {
            ...
            "name": "Player 1",
            "alias": "Jackson",
            "roleActions": {"remainingVests": 100},
        },
        {"id": "2", "name": "Player 2", "alias": "Brandon"},
    ]
    config = {
        "tags": [
            "town_government",
    ...
    try:
        game = Mafia.new_game(players, config)
    except Mafia.AssConfigException:
...
def simulate():
    ...
    state = {
        "day": 1,
        "players": [
            {"number": 1, "alias": "Brandon", "alive": True},
            {"number": 2, "alias": "Gordon", "alive": True},
            {"number": 3, "alias": "Dog", "alive": True},
            {"number": 4, "alias": "Jackson", "alive": True},
            {"number": 5, "alias": "Scrooge", "alive": True},
            {"number": 6, "alias": "Rory", "alive": True},
            {"number": 7, "alias": "Muck", "alive": True},
            {"number": 8, "alias": "Dinkle", "alive": True},
            {"number": 9, "alias": "Bertha", "alive": True},
            {"number": 10, "alias": "Kody", "alive": True},
            {"number": 11, "alias": "Car", "alive": True},
            {"number": 12, "alias": "Mick", "alive": True},
            {"number": 13, "alias": "Bronson", "alive": True},
            {"number": 14, "alias": "Wesley", "alive": True},
            {"number": 15, "alias": "Brett", "alive": True},
        ],
        "graveyard": [],
    }
    config = {
        ...
        "roles": {
            "Citizen": {"max": 1, "weight": 1, "settings": {"maxVests": 2}},
            "Mayor": {"max": 0, "weight": 1, "settings": {}},
            "Doctor": {"max": 0, "weight": 1, "settings": {}},
            "Bodyguard": {"max": 0, "weight": 1, "settings": {}},
            "Escort": {"max": 0, "weight": 1, "settings": {}},
            "Sheriff": {"max": 0, "weight": 1, "settings": {}},
            "Investigator": {"max": 0, "weight": 1, "settings": {}},
            ...
            "Consort": {"max": 0, "weight": 1, "settings": {}},
            "Janitor": {"max": 0, "weight": 1, "settings": {}},
            "Survivor": {"max": 0, "weight": 1, "settings": {}},
            "SerialKiller": {"max": 0, "weight": 1, "settings": {}},
            "Enforcer": {"max": 0, "weight": 1, "settings": {}},
        },
    }
