...
def test_citizen_boostrap() -> Tuple[roles.Citizen, roles.Citizen, roles.Mafioso]:
    ...
    citizen_1 = roles.Citizen(models.Player(**{'name': 'A', 'alias': 'test_citizen_1', 'number': 1, 'id': '1'}))
    citizen_2 = roles.Citizen(models.Player(**{'name': 'B', 'alias': 'test_citizen_2', 'number': 2, 'id': '2'}))
    mafioso_1 = roles.Mafioso(models.Player(**{'name': 'C', 'alias': 'test_mafioso_1', 'number': 3, 'id': '3'}))
    
    logging.debug([citizen_1, citizen_2, mafioso_1])
    return citizen_1, citizen_2, mafioso_1

def test_citizen_find_targets(test_citizen_boostrap: Tuple[roles.Citizen, roles.Citizen, roles.Mafioso]):
...
def test_citizen_find_allies(test_citizen_boostrap: Tuple[roles.Citizen, roles.Citizen, roles.Mafioso]):
    logging.info("--- TEST: Citizen find allies ---")
    citizen_1, citizen_2, mafioso_1 = test_citizen_boostrap
    
    citizen_1.find_allies([citizen_2, mafioso_1])
    assert len(citizen_1.allies) == 0

def test_citizen_action(test_citizen_boostrap: Tuple[roles.Citizen, roles.Citizen, roles.Mafioso]):
...
def test_citizen_win(test_citizen_boostrap: Tuple[roles.Citizen, roles.Citizen, roles.Mafioso]):
