...
def test_actor_night_immune(test_actor_boostrap: Tuple[roles.Citizen, roles.Citizen, roles.Mafioso]):
...
def test_actor_visit(test_actor_boostrap: Tuple[roles.Citizen, roles.Citizen, roles.Mafioso]):
...
def test_actor_die(test_actor_boostrap: Tuple[roles.Citizen, roles.Citizen, roles.Mafioso]):
